...
def _build_react_graph(
    ...
    """
    effective_llm_type = llm_type_override or llm_type or AGENTIC_LLM_TYPE
...
async def generate_answer_agentic(
    ...
    try:
        ...
        graph = _build_react_graph_with_fallback(request.llm_type, tools, system_prompt, checkpointer)
