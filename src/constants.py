...
POLICY_NOT_ANSWER = """
Oops, that's outside my orbit! I'm here to talk about Earth Observation. If you'd like, we can explore satellites, remote sensing, or climate topics instead.
"""
